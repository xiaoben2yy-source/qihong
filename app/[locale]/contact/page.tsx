...
export default function ContactPage({ params }: { params: { locale: string } }) {
  ...
  const contactInfo = [
    ...
    {
      icon: 'M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.326a1 1 0 01-.961 1.199c-.47.05-.927.05-1.396.05A15.192 15.192 0 012 3zm15.464 2.582a1 1 0 00-.986-.836H14.77a1 1 0 00-.959 1.239l.046.256a14 14 0 01-3.896 7.229 1 1 0 001.264 1.673 16 16 0 004.512-4.512 1 1 0 00-1.197-.959l-.256.046zM17.5 5.5a1 1 0 100-2 1 1 0 000 2z',
